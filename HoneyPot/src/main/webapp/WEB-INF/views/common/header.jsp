...
<body>
	<div id="wrapper">
		<div id="side-bar">
			<div id="logo-area">
				<span>
					<img src="/app/resources/logo.png" height="45px">
					<span>HONEYPOT</span>
				</span>
			</div>
			<div id="all-center">
			...
			<div id="menu-area">
				<div id="blank02"></div>
				<div id="icon-area">
					<div><i class="fa-regular fa-user fa-2x" style="color: #2e2e2e;"></i></div>
					<div><i class="fa-solid fa-user-group fa-2x" style="color: #2e2e2e;"></i></div>
					<div><i class="fa-regular fa-pen-to-square fa-2x" style="color: #2e2e2e;"></i></div>
					<div><i class="fa-solid fa-building-user fa-2x" style="color: #2e2e2e;"></i></div>
					<div><i class="fa-solid fa-map-location-dot fa-2x" style="color: #2e2e2e;"></i></div>
				</div>
				<div id="text-area">
					<div>마이페이지</div>
					<div>이웃목록</div>
			...
			<div id="header">
				...
				<div id="header-icon-area">
					<div id="header-weather">
						<div><img src="/app/resources/temp/weather.png" height="35px"></div>
