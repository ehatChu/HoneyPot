...
<body>
	...
	<main>
		<div class="margin">
			...
			<input type="hidden" value="BICYCLE" name="kinda">
				<div>
					<span class="big-text">자전거목록</span><input type="submit" class="small-btn color-gray" value="삭제하기"><button type="button" class="small-btn color-main" id="regi-btn">등록하기</button>
				</div>
		...
		<div id="modal-box">
			<div id="registration" style="display: none;">
				<div id="modal-top">
					<span id="mine-header">자전거등록</span><span><i class="fa-solid fa-xmark fa-2xl margin-right quit-btn" style="color: #000000;"></i></span>
				</div>
				<form action="/app/regi-mine" method="post" enctype="multipart/form-data" onsubmit="return checkIMG();">
					<div id="img-area">
						...
						<div id="regi-content" class="margin15">
							<div class="big-mine-text"><input type="hidden" name="mineCno" value="20">자전거등록</div>
							<div class="bold-text">사유물 이름</div> <div><input type="text" name="name" placeholder="예시)니콜라이 G1EBOXX" class="input-area"></div>
							<div class="bold-text">사유물 고유번호</div> <div><input type="text" name="uniqueNum" placeholder="예시)경비원이 부여한 자전거 번호" class="input-area"></div>
...
<script>
	...
	secondNav(['캘린더', '가계부','자동차','자전거'], '자전거'); // 1st param : 서브 메뉴 목록, 2st param : 현재 서브 메뉴
