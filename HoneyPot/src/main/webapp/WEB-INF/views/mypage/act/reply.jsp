			...
			<div class="list-bg">
				...
				<div class="page-area">
					...
					<c:if test="${pv.currentPage > 1}">
						<button type="button" onclick="location.href='/app/mypage/act/reply?p=${pv.currentPage - 1}'"> < </button>
					</c:if>
					<c:forEach begin="${pv.startPage}" end="${pv.endPage}" step="1" var="i">
						<c:if test="${pv.currentPage != i}">
							<button type="button" onclick="location.href='/app/mypage/act/reply?p=${i}'">${i}</button>
						</c:if>
						<c:if test="${pv.currentPage == i}">
