<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
		<div id="floor">
			<div id="login-area">
				<form id="loginForm" action="/app/member/emailChangePwd" method="post" onsubmit="return validateForm()">
					<input hidden type="text" class="box" name="id" value="${id}">
					<div></div>
					<div class="logo">
						<img id="logo" src="/app/resources/main/honeyPot.png" onclick="location.href = '/app/member/mlogin';">
					</div>
					<div></div>
					<div id="tit"></div>
					<div></div>
					...
					<div></div>
					<div></div>
					<input type="submit" class="box box2" value="비밀번호 재설정">
					<div></div>
				</form>
			</div>
		</div>
