		...
		<div id="main-wrapper">
			...
			<form action="/app/admin/innerFac/deleteImg" method="post">
				...
				<div>
					<h1>시설사진삭제</h1>
					<div>등록된 사진 목록</div>
					<input type="hidden" value="3" name="facNo">
...
<script>
	...
	firstNav(['관리비', '편의시설 관리', '조식관리'],'편의시설관리'); // 1st param : 메인 메뉴 목록, 2st param : 현재 메인 메뉴
	secondNav(['도서관','수영장','헬스장','골프장','예약자통합조회'], '헬스장'); // 1st param : 서브 메뉴 목록, 2st param : 현재 서브 메뉴
