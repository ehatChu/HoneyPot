...
<body>
	...
	<main>
		...
		<form>
			<input type="hidden" value="4" name="amenityNo">
...
<script>
	...
	firstNav(['도서관', '수영장', '헬스장','골프장'], '골프장'); // 1st param : 메인 메뉴 목록, 2st param : 현재 메인 메뉴
	...
	secondNavLink(['/app/innerFac/info?no=4','/app/facilities/golf/reserve'],);
