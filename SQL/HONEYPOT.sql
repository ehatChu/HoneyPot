...
CREATE TABLE MEMBER (
	...
	PROFILE	VARCHAR2(500)	DEFAULT 'basic.png'	NULL,
...
CREATE TABLE PERSONAL_VOTE (
    ...
    VOTE_NOTICE_NO  NUMBER  NOT NULL
);
...
CREATE TABLE AROUND (
	NO	NUMBER		NOT NULL,
	PLACE_NAME	VARCHAR2(500)	NULL,
    ADDRESS_NAME	VARCHAR2(500)	UNIQUE	NULL,
    ROAD_ADDRESS_NAME	VARCHAR2(500)   UNIQUE	NULL,
    CATEGORY_GROUP_NAME	VARCHAR2(500)		NULL,
    PHONE	VARCHAR2(500)		NULL
);
...
--UNIQUE제약조건 추가
ALTER TABLE AMENITY_RESERVATION ADD CONSTRAINT ONLY_ONE_RESERVATION UNIQUE (MEMBER_NO,RESERVE_TIME);
...
ALTER TABLE VOTE_CANDIDATE ADD CONSTRAINT FK_VOTE_TO_CANDIDATE FOREIGN KEY (
	NOTICE_NO
)
REFERENCES VOTE (
    NOTICE_NO
...
ALTER TABLE PERSONAL_VOTE ADD CONSTRAINT FK_CANDIDATE_TO_PERSONAL FOREIGN KEY (
	VOTE_LIST_NO,
    VOTE_NOTICE_NO
)
REFERENCES VOTE_CANDIDATE (
    NO,
    NOTICE_NO
);

ALTER TABLE PERSONAL_VOTE ADD CONSTRAINT FK_VOTE_TO_PERSONAL FOREIGN KEY (
	VOTE_NOTICE_NO
)
REFERENCES VOTE (
    NOTICE_NO
...
ALTER TABLE PERSONAL_VOTE ADD CONSTRAINT FK_MEMBER_TO_PERSONAL FOREIGN KEY (
	MEMBER_NO
)
REFERENCES MEMBER (
    NO
